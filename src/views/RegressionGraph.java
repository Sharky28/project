...
public class RegressionGraph extends ApplicationFrame {
    private final String pathtoprices ="C:\\Users\\sharmarke\\Desktop\\FYP\\src\\prices.txt";
    ...
    public static void main(String[] args) throws IOException {
        RegressionGraph demo = new RegressionGraph("prices.txt");
        demo.pack();
    ...
    public RegressionGraph(String inputFileName) throws IOException {
        super("Technobium - Linear Regression");

        // Read sample data from prices.txt file
        inputData = createDatasetFromFile(pathtoprices);
...
//       File file = new File(classLoader.getResource(fileName).getFile());
        Scanner scanner = new Scanner(new File(pathtoprices));
    ...
    private JFreeChart createChart(XYDataset inputData) throws IOException {
        ...
        JFreeChart chart = ChartFactory.createScatterPlot(
                "Sentiment vs Price", "Price", "Sentiment", inputData,
